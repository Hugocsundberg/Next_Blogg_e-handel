...
export const getOptions = (aboutMe:(AboutMe | undefined), slug:string | undefined, isAboutMe?:boolean) : Array<NavOption> => {
    ...
    const optionsArray:Array<NavOption> = [
        ...
        {isActive: slug === 'atelje' ? true : false, text: 'Ateljé', image: '/imageIcon.svg', link: '/atelje'},
    ]
    if(aboutMe) optionsArray.splice(2, 0, {isActive: isAboutMe ? true : false, text: 'Marina Sundberg', image: '/personIcon.svg', link: `/${aboutMe.slug.current}`})  

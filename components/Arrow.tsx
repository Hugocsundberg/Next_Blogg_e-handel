...
const Background = styled.div<{ right: boolean; fadeOut: boolean }>`
  ...
  @media (max-width: 700px) {
    ...
    width: 2.8rem;
    right: ${(props) =>
      props.right ? "3.5rem" : `calc(100% - 5rem - 1.3rem)`};
  }
  @media (max-width: 600px) {
    height: 2.4rem;
    width: 2.4rem;
    right: ${(props) =>
      props.right ? "3rem" : `calc(100% - 4.5rem - 1.3rem)`};
  }
  @media (max-width: 500px) {
    right: ${(props) =>
      props.right ? "2.5rem" : `calc(100% - 3.5rem - 1.3rem)`};
  }
  @media (max-width: 400px) {
    right: ${(props) =>
      props.right ? "2rem" : `calc(100% - 2.5rem - 1.3rem)`};
    height: 2rem;
    width: 2rem;
  }
`;
